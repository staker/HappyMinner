...
/**
 *  * 为ViewPager添加布局（Fragment），绑定和处理fragments和viewpager之间的逻辑关系  *  * Created
 * with IntelliJ IDEA.  * Author: wangjie  email:tiantian.china.2@gmail.com  *
 * Date: 13-10-11  * Time: 下午3:03  
 */
public class ComplexViewPagerAdapter extends PagerAdapter implements
	...
	public ComplexViewPagerAdapter(FragmentManager fragmentManager,
...
//			ft.commit();为了避免报错，以后这块都可以用下面的方法代替提交方法，即允许数据丢失
	...
	/**
	 *      * 设置页面切换额外功能监听器      * @param onExtraPageChangeListener      
	 */
