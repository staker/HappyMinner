...
/**
 这是 首页产品报价的适配器
 */
public class AdapterSearchList extends BaseRecyclerAdapter<AdapterSearchList.ViewHolderA> {
    private Context mContext;
    private ArrayList<UserPojo> list;

    public AdapterSearchList(Context mContext, ArrayList<UserPojo> list) {
    ...
    public void onBindViewHolder(ViewHolderA holder, int position) {
        ...
        holder.txtName.setText(user.userName+"("+user.userId+")");
