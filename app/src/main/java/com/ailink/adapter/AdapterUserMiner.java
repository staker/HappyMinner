...
/**
 这是 首页产品报价的适配器
 */
public class AdapterUserMiner extends BaseRecyclerAdapter<AdapterUserMiner.ViewHolderA> {
    private Context mContext;
    private ArrayList<UserPojo> list;

    public AdapterUserMiner(Context mContext, ArrayList<UserPojo> list) {
    ...
    public ViewHolderA onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_adapter_user_miner, parent, false);
