...
public class AutoUtils
{
    ...
    public static void autoMargin(View view)
    {
        ...
        Object tag = view.getTag(com.zhy.autolayout.R.id.id_tag_autolayout_margin);
        if (tag != null) return;
        view.setTag(com.zhy.autolayout.R.id.id_tag_autolayout_margin, "Just Identify");
    ...
    {
        Object tag = view.getTag(com.zhy.autolayout.R.id.id_tag_autolayout_padding);
        if (tag != null) return;
        view.setTag(com.zhy.autolayout.R.id.id_tag_autolayout_padding, "Just Identify");
    ...
    public static void autoSize(View view)
    {
        ...
        Object tag = view.getTag(com.zhy.autolayout.R.id.id_tag_autolayout_size);
        if (tag != null) return;

        view.setTag(com.zhy.autolayout.R.id.id_tag_autolayout_size, "Just Identify");
