...
//                    webview.loadUrl(temp);
    ...
    public void initViews(Bundle savedInstanceState) {
        ...
        initIdsClickLinstener(R.id.layout_back,R.id.layout_gift);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.layout_gift:
                String url01= WebUrls.App_Rank_Prize+ Configuration.getInstance(this).getEncodeUserToken();
                JumpActivityUtil.showRankGiftActivity(this,"奖励&规则",url01);
            break;
        }
    }
}