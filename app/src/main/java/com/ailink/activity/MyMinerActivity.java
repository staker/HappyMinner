...
public class MyMinerActivity extends BaseActivity {
    ...
    protected void initViews(Bundle savedInstanceState) {
        setContentView(R.layout.activity_my_miner);
    ...
    private void payBuyPoolPkg(final MissionPojo missionPojo){
        DialogUtil.showDialogNormal(this, "此矿工位任务,需要花费"+missionPojo.price+"蓝钻\n是否付费并开启矿工位?", "我再想想", "开启", new DialogUtil.OnIndexButtonListener() {
            @Override
    ...
    private void buyPackage(MissionPojo missionPojo){
        ...
        ServerUtil.sendBuyPackage(missionPojo.id,new HttpObjectListener() {
            ...
            public void onSucess(Object object) {
                ...
                ToastUtil.showToast("矿工位置开启成功",mContext);
                refreshData();
            }
            @Override
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.txt_mission01:
                ...
                JumpActivityUtil.showNormalActivity(this,MainActivity.class);
//                finish();
                break;
            case R.id.txt_mission02:
                JumpActivityUtil.showNormalActivity(mContext, InviteFriendActivity.class);
                break;
            ...
            case R.id.txt_mission04:
                String url= WebUrls.App_Wallet+Configuration.getInstance(this).getEncodeUserToken();
                JumpActivityUtil.showWebActivity(this,"钱包",url,true);
                break;
        }
    }
    ...
    private void initRecyclerMyMiner() {
        ...
        adapter =new AdapterMyMiner(this, listMiner);
...
//        topBar.setRightText("矿工位 "+size+"/"+userSelf.minerPkgCount);
        topBar.setRightText("矿工位 "+size+"/7");
