...
public class TopBarLayoutUtil {
    public static int backImageResIdWhite = R.mipmap.nav_back_white;//白色的返回按钮,默认是这种颜色的返回按钮
    public static int backImageResIdGray = R.mipmap.nav_back_gray;//灰色的返回按钮
    ...
    public void setBackListener(final IOnClick onClick){
        if(onClick==null){
            return;
        }
...
//    }
     ...
     */
    public void setLeftImage(int drawableResId) {
        if (imgLeft != null) {
            imgLeft.setBackgroundResource(drawableResId);
        }
    }
