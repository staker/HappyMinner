...
public class RefreshFooter extends BaseFooter {
    ...
    public RefreshFooter(Context context,boolean isShowText){
        this(context, 0, com.liaoinstan.springview.R.drawable.arrow,0,isShowText);
    }

    public RefreshFooter(Context context,int logoSrc){
        this(context, 0, com.liaoinstan.springview.R.drawable.arrow,logoSrc,false);
    }

    public RefreshFooter(Context context,int logoSrc,boolean isShowText){
        this(context, 0, com.liaoinstan.springview.R.drawable.arrow,logoSrc,isShowText);
    }

    public RefreshFooter(Context context,int rotationSrc,int arrowSrc,int logoSrc,boolean isShowText){
    ...
    public View getView(LayoutInflater inflater,ViewGroup viewGroup) {
        View view = inflater.inflate(com.liaoinstan.springview.R.layout.ali_footer, viewGroup, true);
        footerTitle = (TextView) view.findViewById(com.liaoinstan.springview.R.id.ali_footer_text);
        footerArrow = (ImageView) view.findViewById(com.liaoinstan.springview.R.id.ali_footer_arrow);
        footerLogo = (ImageView) view.findViewById(com.liaoinstan.springview.R.id.ali_footer_logo);
        footerProgressbar = (ProgressBar) view.findViewById(com.liaoinstan.springview.R.id.ali_footer_progressbar);
